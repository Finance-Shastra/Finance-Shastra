...
import logo from '../assests/Logo design.png';
          ...
          {isForgotPassword ? (
            isResetPasswordStep ? (
              ...
              <form onSubmit={handleForgotPasswordEmailSubmit}>
                ...
                <button type="submit" className="nextsign-in-btn">Next</button>
                <button type="button" className="cancel-btn" onClick={() => setIsForgotPassword(false)}>Cancel</button>
              </form>
            )
          ) : (
            <form onSubmit={handleSubmit}>
              ...
              <div className="login-options">
                ...
                <span onClick={handleForgotPasswordClick} className="forgot-password-link">Forgot Password?</span>
              </div>
